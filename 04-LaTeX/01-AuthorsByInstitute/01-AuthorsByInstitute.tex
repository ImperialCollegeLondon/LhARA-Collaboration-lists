...
\noindent \textit{CERN, CH-1211 Genève 23, Switzerland} \\
A.M~Lombardi \\
 
\noindent \textit{Department of Physics, Lancaster University, Bailrigg, Lancaster, LA1 4YW, UK} \\
E.~Boella$^{1}$, T.S.~Dascalu$^{1}$, Stuart~R.~O'Neill$^{1}$, P.~Ratoff$^{1}$ \\
{\footnotesize
...
\noindent \textit{Institut des Sciences Moléculaires d'Orsay, Rue André Rivière, Bâtiment 520, 91400 Orsay, France} \\
...
\noindent \textit{Joint Department of Physics, Institute of Cancer Research and Royal Marsden NHS Foundation Trust, Sir Richard Doll Building
...
G.Casati$^{1}$, Nicholas~P.Dover$^{1}$, C.Dyson$^{1}$, W.~G.~Jones$^{2}$, P.B.~Jurj$^{1}$, T.J.~Kuo$^{1, 3}$, Ajit~Kurup$^{1}$, Kenneth~R.~Long$^{1, 4}$, M.~Maxouti$^{1, 4}$, Josie~M.~McGarrigle$^{5}$, Z.~Najmudin$^{1}$, J.~Pasternak$^{1, 3}$, R.Razak$^{1}$, Z.~Sadhur, R.~Smith, N.~Zakhir \\
{\footnotesize
  ...
  5. Also at Institut Curie,  73 Rue Claude Bernard,  75005, Paris, France  \\
}
...
M.Alderton, Robert~Bingham$^{1}$, E.Dolier, Ross~J.~Gray$^{2}$, M.King, Paul~McKenna$^{2}$, David~Spiers$^{2}$, B.Torrance, Colin~Whyte$^{2}$, Robbie~Wilson \\
{\footnotesize
...
Yolanda~Prezado$^{1, 2}$ \\
{\footnotesize
  1. Also at Institut Curie,  73 Rue Claude Bernard,  75005, Paris, France  \\
