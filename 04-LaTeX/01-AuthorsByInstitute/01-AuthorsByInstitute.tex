...
\noindent \textit{East China University of Technology: Nanchang, Jiangxi Province, CN} \\
W.Zhang \\
 
\noindent \textit{Helmholtz Zentrum Dresden Rosendorf} \\
W.Schram \\
 
\noindent \textit{The Institute of Cancer Research, 123 Old Brompton Road, London, SW7 3RP, UK} \\
J.~Bamber, Emma~J.~Harris, U.~Oelfke \\
...
\noindent \textit{London} \\
T.Fulcher, A.Howard, C.A.Jamieson, P.Jurj, V.Lay, A.Macintosh-Laroque \\
...
G.Casati$^{1}$, T.S.Dascalu$^{1}$, Nicholas~P.Dover$^{1}$, C.Dyson$^{1}$, O.C.~Ettlinger$^{1}$, W.~G.~Jones$^{2}$, T.J.~Kuo$^{1, 3}$, Ajit~Kurup$^{1}$, H.T.~Lau, Kenneth~R.~Long$^{1, 4}$, M.~Maxouti$^{1, 4}$, Josie~M.~McGarrigle$^{5}$, Z.~Najmudin$^{1}$, J.~Pasternak$^{1, 3}$, J.~Pozimski$^{1, 3}$, r.razak22@imperial.ac.uk$^{1}$, R.~Smith \\
{\footnotesize
...
Alfredo~Fernandez-Rodriguez$^{1}$, F.Pouzoulet \\
{\footnotesize
...
\noindent \textit{Cant really see affiliation; in ORCID seems not to have employment beyond 2008} \\
P.raj~Pushpakaram \\
...
Philip~N.~Burrows$^{1}$, M.~Dosanjh$^{1}$ \\
{\footnotesize
...
J.B.~Lagrange, S.Machida, D.Posthuma~de~Boer, C.~Rogers, J.W.G.~Thomason \\
...
Christopher~J.~Baker, M.~Charlton, Stefan~J.~Eriksson, C.A.~Isaac, O.Nicholas, P.~Ruksasakchai \\
